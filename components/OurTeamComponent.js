          ...
          <div className={classnames(styles.ourTeam)}>
            ...
            <div>
              <p>
                ...
                Mark takes much pride in our company's excellent reputation for
                being honest with high integrity and quality standard. He also
                takes equal pride in our high level of customer service and our
                award-winning professional team. Mark’s personal time is taken
                up in his leadership role in local community service, and
          ...
          <div className={classnames(styles.ourTeam)}>
            ...
            <div>
              <p>
                ...
                client relationship. She works closely with the clients to
                ensure the seamless coordination and approach their needs in
                professional and timely manner. Her favourite subject being
                psychology, she strongly believes{' '}
                <span>
                  "I have learnt that people will forget what you said or did
                  but they will never forget how you made them feel."
                </span>{' '}
                Iram is also involved in the designing of customer focused
                management system
              </p>
            </div>
          </div>
          ...
          <div className={classnames(styles.ourTeam)}>
            ...
            <div>
              <p>
                ...
                years of experience and is the brains behind our though training
                regime. Ramya ensures competitive pricing for the jobs, ensures
                smooth operations with strong eye for detail, skilled problem
                solving and experienced solution specialist. She is also focused
                on product quality and source.
              </p>
            </div>
          </div>
          <div className={classnames(styles.ourTeam)}>
            ...
            <div>
              <p>
                Jira is a graduate in Business Administration and IT. Also
                worked as a key Accounts Manager. Jira takes immense care in
                making sure the job is completed accurately and takes care of
                the scheduled works to be completed.
              </p>
            </div>
          </div>
          <div className={classnames(styles.ourTeam)}>
      ...
      <div className={classnames('bg-light', styles['staff'])}>
        ...
        <div className={classnames(styles['leadership'])}>
          ...
          <div className={classnames(styles.ourTeam)}>
            ...
            <div>
              <p>
                30 years Membrane roof experience, key member of our management
                team. Kevin joined us 7 years ago and is well known, as one of
                the most respected experts of membrane roofs in Sydney.
              </p>
            </div>
          </div>
          <div className={classnames(styles.ourTeam)}>
          ...
          <div className={classnames(styles.ourTeam)}>
            ...
            <div>
              <p>
                ...
                Stuart is a driven performer with metal and tile roofs and also
                guttering rainwater systems. He has a keen interest in
